...
namespace OMSamples
{
    ...
    {
        void Run(PhoneSystem ps, params string[] args);
    }
    public static class SampleStarter
    {
        ...
        public static void StartSample(PhoneSystem ps, params string[] args)
        {
            if (args.Length == 0 || args[0] == "?" || (args.Length>1&&args[1] == "?"))
            {
                //TODO print all
                Console.WriteLine("Usage:");
                Console.WriteLine("\tdotnet OMSamplesCore.dll ?|SampleName [ [?] | [arg1 [arg2 ...]] ]");
                Console.WriteLine("List of samples:");
                Console.WriteLine();
                foreach (KeyValuePair<string, ISample> pair in samples.Where(x => args[0] == "?" || x.Key == args[0]))
                {
            ...
            try
            {
                samples[sampleName].Run(ps, args);
            }
