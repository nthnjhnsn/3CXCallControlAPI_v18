...
namespace OMSamples.Samples
{
    ...
    public class BlackListChecker
    {
        ...
        PhoneSystem ps;
        public BlackListChecker(PhoneSystem ps_in)
        {
            ps = ps_in;
        }
        ...
        public BlackListEntry InsertOrUpdateEntry(string theaddr, string themask, TimeSpan blockingtime, string description)
        {
            ...
            if (theObj == null)
            {
                theEntry = ps.CreateBlackListEntry();
    ...
    public class BlackList
    {
        ...
        PhoneSystem ps;
        private Dictionary<BlackListEntry, BlackListEntryHolder> BuildNewBlackList()
        {
            var retval = new Dictionary<BlackListEntry, BlackListEntryHolder>();
            BlackListEntry[] thearr = ps.GetAll<BlackListEntry>();
        ...
        public BlackList(PhoneSystem ps_in)
        {
            ps = ps_in;
            blc_ = new BlackListChecker(ps);
            lock (this)
            {
                ps.Updated += ps_Updated;
                ps.Inserted += ps_Inserted;
        ...
        Dictionary<BlackListEntry, BlackListEntryHolder> the_set = new Dictionary<BlackListEntry, BlackListEntryHolder>();
