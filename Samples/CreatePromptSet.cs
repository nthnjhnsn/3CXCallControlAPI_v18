...
namespace OMSamples.Samples
{
    ...
    class CreatePromptSetSample : ISample
    {
        ...
        {
            using (var myPromptSet = ps.CreatePromptSet("My Custom PromptSet", "folder in IVR prompts", "dn", "dn"))
            {
                ...
                List<Prompt> myListOfPrompts = new List<Prompt>();
                for (int i = 0; i < 100; i++)
                {
                ...
                //Parameter p = ps.GetParameterByName("ACPRMSET");
