                    ...
                    case "create":
                        {
                            ...
                            if (source != null && ps.GetAllAudioFeeds().Any(x => x.Source.Equals(source)))
                            {
                                Console.WriteLine("Source already bound");
                                return;
                            }

                            if (name != null && ps.GetAllAudioFeeds().Any(x => x.Source.Equals(source)))
                            {
                                Console.WriteLine("Source already bound");
                                return;
                            }
