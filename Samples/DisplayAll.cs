    ...
    class DisplayAllSample : ISample
    {
        ...
        public void Run(PhoneSystem ps, params string[] args)
        {
            ...
            while (!Program.Stop)
            {
                ...
                ps.GetInternalStat(intermediateStat);
                ...
                foreach (var dayOfWeek in ps.GetTenant().Hours)
                {
                ...
                foreach (var dayOfWeek in ps.GetTenant().BreakTime)
                {
